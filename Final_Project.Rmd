...
![](https://i.pinimg.com/originals/8c/26/f3/8c26f3e2b10e6a1e3ee507ebca24bafd.jpg)
...
turtlemap <- turtle %>%
   ...
   addLayersControl( # add layers to map
    ...
    options = layersControlOptions(collapsed = TRUE) # collapses the layers panel so that the map is more visually appealling
  )
turtlemap # print the map
```
